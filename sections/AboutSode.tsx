        ...
        <Container>
          ...
          <div className="flex flex-col items-center text-center mx-auto px-4">
            ...
            <div className="space-y-4 text-sm text-gray-300 font-medium leading-relaxed">
              <p>
                SODE (School of Online & Distance Education) is India&apos;s top
                educational platform, transforming the way learners engage with
                higher education. We make higher education easier without
