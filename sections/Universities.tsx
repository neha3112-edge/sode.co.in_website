...
const universities = [
  {
    ...
    logoSrc: "/1-year-mba/assets/images/rushford-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/rushford-image.png",
    courses: ["Rushford DBA"],
    brochureUrl: "/1-year-mba/assets/pdf/rushford_main_brochure.pdf",
    paragraphs: [
  ...
  },
  {
    ...
    logoSrc: "/1-year-mba/assets/images/ggu-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/ggu-image.png",
    courses: ["Online DBA", "Online MBA"],
    brochureUrl: "/1-year-mba/assets/pdf/ggu_main_brochure.pdf",
    paragraphs: [
  ...
  {
    name: "SSBM Geneva",
    logoSrc: "/1-year-mba/assets/images/ssbm-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/ssbm-image.png",
    courses: ["Online DBA"],
  ...
  {
    name: "ESGCI",
    logoSrc: "/1-year-mba/assets/images/esgci-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/esgci-image.png",
    courses: ["Online DBA"],
    brochureUrl: "/1-year-mba/assets/pdf/esgci_main_brochure.pdf",
    paragraphs: [
  ...
  },
  {
    ...
    logoSrc: "/1-year-mba/assets/images/edgewood-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/edgewood-image.png",
    courses: ["Online DBA", "MBA + DBA"],
    brochureUrl: "/1-year-mba/assets/pdf/edgewood_main_brochure.pdf",
    paragraphs: [
  ...
  },
  {
    ...
    logoSrc: "/1-year-mba/assets/images/liverpool-logo.png",
    imageSrc: "/1-year-mba/assets/images/liverpool-image.png",
    courses: ["MBA Online"],
    brochureUrl: "/1-year-mba/assets/pdf/liverpool_main_brochure.pdf",
    paragraphs: [
  ...
  {
    name: "IIIT Bangalore",
    logoSrc: "/1-year-mba/assets/images/iiitb-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/iiitb-image.png",
    courses: ["Data Science", "CTO Leader Program", "Generative AI", "Artificial Intelligence", "Agentic AI", "Machine Learning"],
    brochureUrl: "/1-year-mba/assets/pdf/iiitb_main_brochure.pdf",
    paragraphs: [
  ...
  {
    name: "IIM Kozhikode",
    logoSrc: "/1-year-mba/assets/images/iim-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/iim-image.png",
    courses: ["Professional Certificate Programme in HR Management and Analytics"],
  ...
  },
  {
    ...
    logoSrc: "/1-year-mba/assets/images/ljmu-logo.png",
    imageSrc: "/1-year-mba/assets/images/liverpool-image.png",
  ...
  {
    name: "MICA",
    logoSrc: "/1-year-mba/assets/images/mica-logo.jpg",
    imageSrc: "/1-year-mba/assets/images/mica-image.png",
    courses: ["Digital Marketing", "SEO & SEM", "Brand Communication", "Social Media"],
    brochureUrl: "/1-year-mba/assets/pdf/mica_main_brochure.pdf",
    paragraphs: [
...
export function Universities() {
  ...
  const [selectedModalUni, setSelectedModalUni] = useState<typeof universities[0] | null>(null);
  ...
  return (
    <section id="prestigious-institutions" className="scroll-mt-10 py-16 md:py-20 bg-white overflow-hidden">
      ...
      {activeModal && selectedModalUni && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-xs transition-opacity duration-300">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-8 max-w-lg w-full relative shadow-2xl overflow-y-auto max-h-[90vh] z-10 transition-transform duration-300 scale-100 animate-scale-in">
            <FormWrapper
              title={activeModal === "brochure" ? "Download Brochure" : "Apply Now"}
              subtitle={
