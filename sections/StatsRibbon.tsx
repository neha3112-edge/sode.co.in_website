  ...
  const stats = [
    {
      ...
      icon: "/1-year-mba/assets/images/salary-hike-logo.jpg",
    },
    {
      value: "15K+",
      label: "Professionals Enrolled",
      icon: "/1-year-mba/assets/images/professional-enrolled-logo.jpg",
    },
    {
      value: "50+",
      label: "Certification Courses",
      icon: "/1-year-mba/assets/images/certification-logo.jpg",
    },
    {
      value: "20+",
      label: "IIT, IIM, Global University",
      icon: "/1-year-mba/assets/images/global-university-logo.jpg",
    },
  ];
    ...
    <section className="w-full bg-linear-to-r from-[#EEC471] via-[#F3CD73] to-[#FADA9A] py-5 md:py-10 shadow-md relative z-10">
      <Container>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 items-center max-w-6xl mx-auto">
          {stats.map((stat, idx) => (
            <div key={idx} className="flex items-center gap-3 md:gap-4 justify-start pl-4 md:pl-2">
              {/* Icon Circle */}
