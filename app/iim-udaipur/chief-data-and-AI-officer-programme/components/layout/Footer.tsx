...
export default function Footer() {
  ...
  const ArrowGif = getAssetPath("/iim-udaipur/chief-data-and-AI-officer-programme/img/arrow.gif");
  const DesLogo = getAssetPath("/iim-udaipur/chief-data-and-AI-officer-programme/img/new-des-logo.webp");
