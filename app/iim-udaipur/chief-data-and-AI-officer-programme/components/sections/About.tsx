...
export function About() {
  ...
  const logoIIITB = getAssetPath(
    "/iim-udaipur/chief-data-and-AI-officer-programme/img/IITB.png",
  );
  const logoIIMU = getAssetPath(
    "/iim-udaipur/chief-data-and-AI-officer-programme/img/IIMU.png",
  );
        ...
        <Container className="max-w-6xl">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
            ...
            <div className="flex flex-col items-center bg-transparent border border-white rounded-[20px] overflow-hidden text-center">
              ...
              <div className="p-6 sm:p-8">
                ...
                <p className="mt-4 text-sm leading-6 text-white/90 text-center">
                  International Institute of Information Technology Bangalore is a leading AI and technology institute established in 1999. It is recognised with NAAC A+ Accreditation and has contributed through 5000+ research papers, 100+ patents, and strong industry collaborations. Its advanced learning ecosystem supports professionals pursuing future-focused data analytics and AI courses and building capabilities for roles such as Chief AI Officer.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center bg-transparent border border-white rounded-[20px] overflow-hidden text-center">
              ...
              <div className="p-6 sm:p-8">
                ...
                <p className="mt-4 text-sm leading-6 text-white/90 text-center">
                  Indian Institute of Management Udaipur is a globally recognised business school with AACSB Accreditation and featured in FT and QS global rankings. It is among the top 6% of globally accredited business schools, offering strong business leadership learning.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 md:mt-12 flex flex-row items-center justify-center gap-2 md:gap-4">
            ...
            <Button
              ...
              className="inline-flex cursor-pointer min-h-10 md:min-h-12 items-center justify-center rounded-xl border-2 border-white bg-transparent px-4 md:px-8 py-3 text-xs md:text-sm font-bold text-white transition-colors duration-200 hover:bg-white hover:text-[#01519A] sm:w-auto"
            >
