...
const steps: JourneyStep[] = [
  {
    step: "Step 01",
    title: "Data & AI Technical Authority",
    duration: "(Months 1-3 | IIIT Bangalore)",
    logo: "/iim-udaipur/chief-data-and-AI-officer-programme/img/IIITB_logo_with_Institute_Name.png",
    desc: "Learners build expertise in data strategy, enterprise architecture, governance, GenAI, Agentic AI, and AI product scaling through advanced data analytics and generative AI courses designed for future data leaders.",
  ...
  },
  {
    ...
    logo: "/iim-udaipur/chief-data-and-AI-officer-programme/img/IIITB_logo_with_Institute_Name.png",
    desc: "Learners translate data and AI investments into business outcomes through CDAIO simulations, decision-making frameworks, and practical applications of a data analytics and AI course online approach.",
    textColor: "text-[#E27E36]",
  },
  {
    step: "Step 03",
    title: "Business Authority & Data Leadership",
    duration: "(Months 4-6 | IIM Udaipur)",
    logo: "/iim-udaipur/chief-data-and-AI-officer-programme/img/IIITB_logo_with_Institute.png",
    desc: "Learners develop skills in data economics, P&L ownership, organisation design, and enterprise data leadership.",
    textColor: "text-[#01519A]",
  },
  {
    step: "Step 04",
    title: "2-Day Data & AI Leadership Workshop",
    duration: "(IIIT Bangalore)",
    logo: "/iim-udaipur/chief-data-and-AI-officer-programme/img/IIITB_logo_with_Institute_Name.png",
    desc: "Learners defend their data strategy and governance architecture before a live panel of industry practitioners.",
      ...
      <section id="program-journey" className="bg-[#fcfdfe] py-14 sm:py-16 lg:py-14 border-b border-gray-100">
        <Container>
          ...
          <div className="text-center">
            <h2 className="text-2xl font-extrabold leading-tight tracking-tight text-[#01519A] sm:text-[34px]">
              CDAIO Program Journey
            </h2>
