...
const faqs: FaqItem[] = [
  {
    question: "What is the role of the IIIT Bangalore campus immersion?",
    answer:
      "The 2-day workshop helps learners design data and AI strategies, governance models, compliance frameworks, and implementation roadmaps through peer collaboration.",
  },
  {
    question: "What skills are covered in this Chief data analyst course 6 months programme?",
    answer:
      "Across 24 weeks, learners develop skills in data strategy, enterprise architecture, data governance, GenAI, Agentic AI, AI products, data economics, and leadership.",
  },
  {
    question:
      "How is this chief AI officer course different from a regular data analytics or AI programme?",
    answer:
      "This programme combines data strategy, GenAI, Agentic AI, governance, regulatory frameworks, and business leadership to prepare professionals for enterprise AI decision-making.",
  },
  {
    question: "What skills are covered in this data analyst course 6 months programme?",
    answer:
      "Across 24 weeks, learners develop skills in data strategy, enterprise architecture, data governance, GenAI, Agentic AI, AI products, data economics, and leadership.",
  },
  {
    question: "What is the fee structure for the Chief Data & AI Officer Program?",
    answer:
      "The fee details for the programme can be downloaded from the brochure . Eligible professionals can apply, get shortlisted, receive their offer, and confirm their seat for the 24-week executive programme.",
  },
];
        ...
        <Container className="max-w-370">
          <div className="text-center">
            <h2 className="text-2xl font-extrabold leading-tight text-[#01519A] sm:text-3xl lg:text-[34px]">
              How to Apply for Chief Data &amp; AI Officer Program
            </h2>
