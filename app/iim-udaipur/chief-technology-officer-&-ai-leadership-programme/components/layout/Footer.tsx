...
export default function Footer() {
  ...
  const ArrowGif = getAssetPath("/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/arrow.gif");
  const DesLogo = getAssetPath("/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/new-des-logo.webp");
    ...
    <>
      <footer className="bg-[#f4f7fa] pt-8 sm:pt-10 lg:pt-12">
        ...
        <section id="compare-university" className="px-4 sm:px-6 lg:px-8">
          <div className="relative mx-auto max-w-446.25 rounded-[20px] bg-[#01519A] px-5 py-12 text-center text-white sm:py-14 lg:py-12">
            ...
            <p className="mx-auto mt-4 max-w-4xl text-sm font-semibold leading-6.6 sm:text-base lg:text-lg">
              Compare IIIT Bangalore & IIM Udaipur with Top UGC-DEB Approved Universities
            </p>
