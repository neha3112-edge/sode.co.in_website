...
const items: HighlightItem[] = [
  {
    icon: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/ic-02.png",
    title: "Eligibility",
    desc: "Graduation with 8 years of experience",
  },
  {
    icon: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/ic-01.png",
    title: "Duration",
    desc: "24 Weeks (6 Months)",
  },
  {
    icon: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/Student Enrolled.png",
    title: "Institutions",
    desc: "IIIT Bangalore & IIM Udaipur",
  },
  {
    icon: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/Institutionn.png",
    title: "30k+",
