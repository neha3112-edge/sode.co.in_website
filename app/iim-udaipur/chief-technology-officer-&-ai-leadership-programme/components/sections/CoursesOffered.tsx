...
const courses: Course[] = [
  {
    ...
    duration: "20 weeks",
    description:
      "IIM Udaipur online courses help leaders learn GenAI strategy and adoption using the A.D.A.P.T. Framework, with real business use cases, a capstone, and executive-level outcomes.",
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/course-1.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/Executive_Program_in_Generative_AI_for_Leaders.pdf",
  },
  {
    id: 2,
    ...
    duration: "25 weeks",
    description:
      "IIM Udaipur online courses build skills in data science and artificial intelligence through statistics, machine learning, deep learning, industry projects, and expert mentorship.",
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/course-2.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/IIITB_EPGC_DS_AI.pdf",
  },
  {
    id: 3,
    title:
    ...
    duration: "24 weeks",
    description:
      "IIM Udaipur online courses deliver practical learning in analytics, ML pipelines, and GenAI, with labs, real datasets, hands-on projects, and portfolio support.",
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/course-3.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/PCP_in_DS_26_Gen_AI_with_IIIT_B.pdf",
  },
  {
    id: 4,
    ...
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/course-4.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/Applied_AI_and_Agentic_AI-4.pdf",
  },
  {
    id: 5,
    ...
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/course-5.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/IIITB_ED_ML.pdf",
  },
  {
    id: 6,
    ...
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/course-6.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/CTOAI_leadership_program.pdf",
  },
  {
    id: 7,
    ...
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/new-image1.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/new-brochure1.pdf",
  },
  {
    id: 8,
    title:
    ...
    duration: "20 months",
    description:
      "Gain advanced knowledge of data science, analytics, statistical modelling, machine learning, generative AI, and data-driven decision-making.",
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/new-image2.webp",
    brochureUrl: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/new-brochure2.pdf",
  },
];
      ...
      {activeForm === "apply" && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="iimu-apply-form-title"
          ...
          >
            ...
            <div id="iimu-apply-form-title">
              <FormWrapper
                ...
                formNameOverride="IIMU Course Apply Form"
      ...
      {activeForm === "brochure" && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="iimu-brochure-form-title"
            onClick={(event) => event.stopPropagation()}
            className="relative max-h-[92vh] w-full max-w-md overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl animate-[scaleIn_0.2s_ease]"
          >
            {/* Close Button */}
            ...
            <div id="iimu-brochure-form-title">
              <FormWrapper
                ...
                defaultCourse=""
                courseOptions={IIMU_COURSE_OPTIONS}
                formNameOverride="IIMU Course Brochure Form"
                sourceOverride="IIMU LP"
                utmSourceFallback="Organic"
                utmMediumFallback="IIMU_Organic"
