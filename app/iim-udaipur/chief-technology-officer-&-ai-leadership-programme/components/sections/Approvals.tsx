...
const approvalItems: ApprovalItem[] = [
  {
    title: "NIRF",
    description:
      "Recognised under the National Institutional Ranking Framework (NIRF), reflecting excellence in higher education.",
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/nirf.png",
    alt: "NIRF logo",
  },
  {
    title: "QS Ranking",
    ...
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/QS logo.webp",
    alt: "QS Ranking logo",
  },
  {
    title: "NAAC A+",
    ...
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/a.png",
    alt: "NAAC A+ logo",
  },
  {
    title: "AACSB",
    ...
    image: "/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/AACSB.webp",
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[320px_1px_1fr] lg:gap-10">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="relative h-36 w-36 sm:h-40 sm:w-40">
              <Image
                src={getAssetPath("/iim-udaipur/chief-technology-officer-&-ai-leadership-programme/img/award-icon.webp")}
