...
const partners = [
  {
    name: "Capco",
    src: "/iimk/ai-strategic-course/assets/img/capco.webp",
  },
  {
    name: "Cognizant",
    src: "/iimk/ai-strategic-course/assets/img/Cognizant.webp",
  },
  {
    name: "Delhivery",
    src: "/iimk/ai-strategic-course/assets/img/Delhivery.webp",
  },
  {
    name: "Capita",
    src: "/iimk/ai-strategic-course/assets/img/capita.webp",
  },
  {
    name: "Disney",
    src: "/iimk/ai-strategic-course/assets/img/disnep.webp",
  },
  {
    name: "Codeyoung",
    src: "/iimk/ai-strategic-course/assets/img/codeyoung.webp",
  },
  {
    name: "CBSPL",
    src: "/iimk/ai-strategic-course/assets/img/cbspl.webp",
  },
];
...
const CERTIFICATION_POINTS: CertificatePoint[] = [
  ...
  },
  {
    id: 3,
    title: "Certification",
    desc: "IIM Kozhikode will award a Certificate of Successful Completion to participants who will successfully complete all the programme modules and assessments."
  }
];
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative mx-auto w-full max-w-[500px]">
              <div className="relative aspect-[1.414/1] w-full overflow-hidden rounded-lg border border-gray-200 bg-white p-2 shadow-xl">
                <Image
                  src={getAssetPath("/iimk/ai-strategic-course/assets/img/sample-certificate.webp")}
