    ...
    <>
      <footer className="bg-[#f4f7fa] pt-8 sm:pt-10 lg:pt-12">
        ...
        <section id="compare-university" className="px-4 sm:px-6 lg:px-8">
          <div className="relative mx-auto max-w-446.25 rounded-[20px] bg-[#1d3d82] px-5 py-12 text-center text-white sm:py-14 lg:py-12">
            ...
            <p className="mx-auto mt-4 max-w-4xl text-sm font-semibold leading-6 sm:text-base lg:text-lg">
              Compare IIM Kozhikode University with Top World Renowned
              Universities
            </p>
            ...
            >
              <Image
                src={getAssetPath("/iimk/ai-strategic-course/assets/img/arrow.gif")}
                alt="Scroll down"
                width={48}
                height={48}
        ...
        <section className="px-4 pb-5 pt-20 sm:px-6 lg:px-8">
          ...
          >
            <Image
              src={getAssetPath("/iimk/ai-strategic-course/assets/img/new-des-logo.webp")}
          ...
          <div className="mx-auto max-w-450 text-center">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-2 gap-y-2 text-sm text-gray-900 sm:text-sm">
              <button
                ...
                className="transition-colors hover:text-[#1d3d82] cursor-pointer"
              >
                Disclaimer
              </button>
      ...
      {activeModal === "disclaimer" && (
        <FooterModal title="Disclaimer" onClose={closeModal}>
          ...
          <h3 className="mt-6 text-lg font-semibold text-[#1d3d82]">
            Essential Points
          </h3>
        ...
        <FooterModal title="Terms and Conditions" onClose={closeModal}>
          ...
          <p className="mt-2">
            ...
            <a
              ...
              className="font-medium text-[#1d3d82] underline"
            >
    ...
    >
      ...
      >
        ...
        <h2
          ...
          className="pr-10 text-center text-2xl font-bold text-[#1d3d82] sm:text-3xl"
        >
          {title}
        </h2>
