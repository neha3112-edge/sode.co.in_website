...
export function Header() {
  ...
  const homePath = "/iit-roorkee/pg-certificate-in-data-science-machine-learning-and-generative-ai";
      ...
      <Container>
        <div className="flex h-18 items-center justify-between">
          ...
          >
            {navItems.map((item, index) => (
              <div key={item.label} className="flex items-center">
                <a
                  href={item.href}
                  className="px-3 py-2 transition-colors duration-200 hover:text-[#3585C1]"
                >
                  {item.label}
                </a>
          ...
          <button
            ...
            className="flex items-center justify-center rounded-md bg-[#3585C1] p-2 text-white transition-all duration-300 lg:hidden"
          >
          ...
          >
            {navItems.map((item) => (
              <a
                ...
                className="rounded-md px-4 py-3 text-center transition-colors duration-200 hover:bg-gray-100 hover:text-[#3585C1]"
              >
