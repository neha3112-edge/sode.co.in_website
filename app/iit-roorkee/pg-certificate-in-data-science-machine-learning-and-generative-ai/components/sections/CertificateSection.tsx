...
const partners = [
  {
    name: "Amazon",
    src: `${basePath}/assets/img/Amazone.png`,
  },
  {
    name: "Asian Paints",
    src: `${basePath}/assets/img/Asian paint.png`,
  },
  {
    name: "Brown Stack",
    src: `${basePath}/assets/img/Brown Stack.png`,
  },
  {
    name: "Fortis",
    src: `${basePath}/assets/img/Forties.png`,
  },
  {
    name: "HCCB",
    src: `${basePath}/assets/img/HCCB.png`,
  },
  {
    name: "Hero",
    src: `${basePath}/assets/img/Hero.png`,
  },
  {
    name: "MakeMyTrip",
    src: `${basePath}/assets/img/Make my Trip.png`,
  },
  {
    name: "Pidilite",
    src: `${basePath}/assets/img/Pedlite.png`,
  },
  {
    name: "Reliance",
    src: `${basePath}/assets/img/Reliance.png`,
  },
  {
    name: "Tata Steel",
    src: `${basePath}/assets/img/Tata Steel.png`,
  },
  {
    name: "Tech Mahindra",
    src: `${basePath}/assets/img/Tech Mahindra.png`,
  },
  {
    name: "GMR",
    src: `${basePath}/assets/img/GAAR.png`,
  },
];
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative mx-auto w-full max-w-[500px]">
              <div className="relative aspect-[1.414/1] w-full overflow-hidden rounded-lg border border-gray-200 bg-white p-2 shadow-xl">
                <Image
                  src={getAssetPath(`${assetsBase}/Certificate IITR.webp`)}
                  alt="IIT Roorkee Data Science Sample Certificate"
                  fill
            ...
            <div className="text-center lg:text-left degree-info">
              <h2 className="text-xl font-extrabold leading-tight text-[#3585C1] sm:text-3xl">
                Sample Certificate in Data Science, Machine Learning & Generative AI From IIT Roorkee
              </h2>

              <p className="mt-5 text-sm leading-relaxed text-gray-600 sm:text-base">
                Upon successfully completing the programme with a minimum overall score of 50% and 75% attendance, learners will receive a Certificate of Completion from the Continuing Education Centre, IIT Roorkee. This certificate validates your expertise in Data Science, Machine Learning, and Generative AI, strengthening your professional credentials in the evolving AI landscape.
              </p>
              ...
              <Button
                ...
                className="mt-8 inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-full bg-[#3585C1] hover:bg-[#256c9e] text-white px-6 py-3 text-sm font-bold transition-colors duration-200"
              >
      ...
      <section id="placement" className="bg-white py-8 sm:py-12">
        <Container>
          <div className="rounded-[32px] border border-gray-100 bg-[#f2f2f2] px-6 py-10 shadow-xs sm:py-12">
            <h2 className="text-center text-xl font-extrabold tracking-wide text-[#3585C1] sm:text-[26px]">
        ...
        >
          ...
          >
            <FormWrapper
              ...
              defaultCourse=""
              formNameOverride="IITR Sample Certificate Form"
              sourceOverride="IITR LP"
              utmSourceFallback="Organic"
              utmMediumFallback="IITR_Organic"
              submitButtonText="Book Now"
              submitButtonClassName="bg-[#3585C1] hover:bg-[#256c9e] text-white"
