...
const faqs: FaqItem[] = [
  {
    question: "Q1. Is this project management certificate PMP suitable for beginners?",
    answer:
      "Yes. It is designed for both aspiring and experienced project management professionals.",
  },
  {
    question: "Q2. Why is this one of the best project management certificate online programmes?",
    answer:
      "It offers live online classes, hands-on learning, Harvard case studies, and an IIT Delhi CEP certificate.",
  },
  {
    question: "Q3. Is this useful before pursuing an associate in project management certification?",
    answer:
      "Yes. It builds strong project management fundamentals and practical skills. Even 7 million project managers are required in India by 2027, so it holds value and relevance in today's job market.",
  },
  {
    question: "Q4. Is this project management course conducted live online?",
    answer:
      "Yes. The programme is delivered through live online sessions every Sunday, making it flexible for working professionals.",
  },
  {
    question: "Q5. What will I gain from this project management course and certification?",
    answer:
      "Learners develop practical skills in planning, Agile, risk management, leadership, and project execution, along with an IIT Delhi CEP certificate.",
  },
];
      ...
      >
        <Container className="max-w-7xl">
          <div className="text-center">
            <h2 className="text-xl font-bold leading-tight text-[#C21717] sm:text-3xl max-w-6xl">
              How to Apply for the Executive Programme in Advanced Project Management (EPAPM)?
            </h2>

            <p className="mx-auto mt-3 max-w-4xl text-sm leading-6 text-gray-600 sm:text-base">
              Enrolling in the <strong>Certified Project Management course</strong> is a seamless and hassle-free process. From submitting your application to securing your admission, each step is designed to ensure a smooth onboarding experience. Simply complete the application, connect with our programme advisors, complete the admission formalities, and get ready to advance your project management career with IIT Delhi.
            </p>
          </div>
        ...
        <Container>
          <div className="text-center">
            <h2 className="text-xl font-extrabold leading-tight text-[#C21717] sm:text-3xl">
              FAQs regarding the Executive Programme in Advanced Project Management
            </h2>
          </div>
...
function FaqAccordionItem({ faq, isOpen, onToggle }: FaqAccordionItemProps) {
  return (
    ...
    >
      ...
      >
        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded bg-[#c21717] text-white">
          {isOpen ? (
