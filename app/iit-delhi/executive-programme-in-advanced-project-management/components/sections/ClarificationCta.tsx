...
export function ClarificationCta() {
  ...
  return (
    <>
      <section id="clarification" className="w-full bg-[#C21717] py-8 sm:py-10">
        <Container>
          <div className="flex flex-col items-center justify-between gap-6 text-center md:flex-row md:text-left">
            ...
            <Button
              ...
              type="button"
              onClick={openForm}
              className="inline-flex min-h-12 w-fit cursor-pointer items-center justify-center gap-2 rounded-full bg-white px-7 py-3 text-sm font-bold text-[#C21717] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-gray-100 hover:shadow-md md:w-auto"
            >
              <Phone
                size={16}
                fill="currentColor"
        ...
        >
          ...
          >
            <FormWrapper
              ...
              defaultCourse=""
              formNameOverride="IITD Clarification CTA Form"
