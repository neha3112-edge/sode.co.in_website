    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 z-0 hidden lg:block">
          <Image
            src={getAssetPath(`${assetsBase}/IIT Delhi Desktop.webp`)}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] items-center gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left px-4 md:px-0">
              ...
              <div className="mb-5 flex items-center justify-center lg:justify-start hidden lg:block">
                <Image
                  src={getAssetPath(`${assetsBase}/IIT Delhi WITH tPROLogo.webp`)}
                  alt="IIT Delhi Pravartak logo"
                  width={200}
                  height={100}
              ...
              >
                ...
                <span className="block">Advanced Project Management</span>
              </h1>

              {/* Provider */}
              <p className="mt-3 text-base sm:text-lg text-gray-800">
                By <span className="underline font-bold">IIT Delhi</span> via{" "}
              ...
              <p className="mt-4 max-w-md text-sm sm:text-base lg:text-[13px] leading-relaxed text-gray-700">
                Advance your expertise with the Project Management Professional certificate course by CEP, IIT Delhi. This helps you gain practical knowledge in strategic project planning to strengthen your career.
              </p>
            ...
            <div className="w-full block lg:hidden">
              <Image
                src={getAssetPath(`${assetsBase}/IIT Delhi Mobile.webp`)}
                alt="IIT Delhi Campus"
                width={500}
                height={290}
                priority
            ...
            <div className="flex justify-center lg:justify-end w-full px-4 md:px-0 -mt-10 md:mt-0">
              <div className="w-full max-w-md rounded-2xl border border-gray-100 bg-white px-5 py-6 sm:px-6 shadow-2xl">
                ...
                <div className="mb-4 text-center">
                  <h2 className="text-[22px] sm:text-[25px] font-extrabold text-[#C21717]">
                    Admission Open
                  </h2>
                  ...
                  <div className="mt-2.5 flex justify-center">
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-[#C21717] px-5 py-1.5 text-xs font-bold text-white transition-colors hover:bg-[#a11313]"
                    >
                      <PhoneCall
                        size={12}
                        fill="currentColor"
                ...
                <FormWrapper
                  ...
                  defaultCourse=""
                  formNameOverride="IITD Hero Enquiry Form"
      ...
      {/* =====================================================
          STATS BAR
      ====================================================== */}
      <section className="bg-[#C21717] py-8 text-white" id="stats">
        <Container>
      ...
      {downloadOpen && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-label="Download IIT Delhi brochure"
            onClick={(event) => event.stopPropagation()}
            className="relative max-h-[92vh] w-full max-w-sm overflow-y-auto rounded-xl bg-white p-6 shadow-2xl"
          >
            <FormWrapper
              title="Download Brochure"
              subtitle="Select your course to receive the IIT Delhi brochure"
              onClose={closeDownloadForm}
              courseOptions={IITD_COURSE_OPTIONS}
              defaultCourse=""
              formNameOverride="IITD Download Brochure Form"
              sourceOverride="IITD LP"
              utmSourceFallback="Organic"
              utmMediumFallback="IITD_Organic"
