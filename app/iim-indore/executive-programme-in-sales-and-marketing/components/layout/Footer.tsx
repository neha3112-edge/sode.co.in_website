...
export default function Footer() {
  ...
  const assetsBase = "/iim-indore/executive-programme-in-sales-and-marketing/assets/img";
        ...
        <section id="compare-university" className="px-4 sm:px-6 lg:px-8">
          <div className="relative mx-auto max-w-446.25 rounded-[20px] bg-[#231069] px-5 py-12 text-center text-white sm:py-14 lg:py-12 shadow-xl">
            ...
            <p className="mx-auto mt-4 max-w-4xl text-sm font-semibold leading-6 sm:text-base lg:text-lg">
              Compare IIM Indore with Top World Renowned Universities
            </p>
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-2 gap-y-2 text-sm text-gray-900 sm:text-sm">
              <button
                ...
                className="transition-colors hover:text-[#231069] cursor-pointer"
              >
                Disclaimer
              </button>
        ...
        <FooterModal title="Terms and Conditions" onClose={closeModal}>
          ...
          <p className="mt-2">
            ...
            <a
              ...
              className="font-medium text-[#231069] underline"
            >
