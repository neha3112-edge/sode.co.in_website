...
export default function IIMIPage() {
  const pagePath = "/iim-indore/executive-programme-in-sales-and-marketing";
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="fixed bottom-16 right-4 z-80 flex flex-col items-center lg:bottom-6 lg:right-6">
        ...
        <FloatingButton
          ...
          formNameOverride="IIMI Scholarship Floating Form"
          ...
          autoOpenSessionKey="iimi-scholarship-form-auto-opened"
      ...
      <div className="lg:hidden">
        <GlobalCTA
          ...
          utmMediumFallback="IIMI_Organic"
          redirectUrl={`${pagePath}/thank-you`}
          whatsappMessage="I want to download the IIM Indore EPSM Online Program brochure"
          applyFormName="IIMI Mobile Bottom Apply Form"
          brochureFormName="IIMI Mobile Bottom Brochure Form"
