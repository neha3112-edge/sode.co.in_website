...
export default function Footer() {
  ...
  */
  ...
  return (
    <>
      <footer className="overflow-hidden bg-[#f4f6f8] pt-12 sm:pt-14 lg:pt-[60px]">
        {/* =============================================================
        ...
        <section className="px-4 pb-6 pt-[74px] sm:px-8 sm:pt-[82px]">
          <button
            type="button"
            onClick={openComparePage}
        ...
        <section className="px-5 pb-4 sm:px-8">
          <Container>
            <div className="mx-auto max-w-[1500px] text-center">
              <p className="text-[11px] font-medium leading-[1.55] text-[#111111] sm:text-[13px]">
                ...
                on the official website of the University before making
                decisions.
              </p>

              <div className="mt-4 flex flex-wrap items-center justify-center gap-x-1.5 gap-y-2 text-[12px] font-extrabold text-black sm:text-[13px]">
                <button
                  type="button"
        ...
        <div className="bg-[#073d72] px-4 py-3 text-center text-[12px] font-medium text-white sm:text-[13px]">
      ...
      {activeModal === "disclaimer" && (
        <FooterModal title="Disclaimer" onClose={closeModal}>
          ...
          <h3 className="mt-6 text-lg font-extrabold text-[#073d72]">
            Essential Points
          </h3>
        ...
        <FooterModal title="Terms and Conditions" onClose={closeModal}>
          ...
          <p className="mt-2">
            ...
            <a
              ...
              className="font-semibold text-[#073d72] underline"
            >
    ...
    >
      ...
      >
        ...
        <h2
          ...
          className="pr-12 text-center text-2xl font-black text-[#073d72] sm:text-3xl"
        >
          {title}
        </h2>
