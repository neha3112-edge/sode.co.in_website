...
const keySkills: Skill[] = [
  {
    iconSrc: "/iimb/assets/img/Leadership & Communication.webp",
  ...
  {
    iconSrc: "/iimb/assets/img/Business Analytics.webp",
  ...
  {
    iconSrc: "/iimb/assets/img/People Management.webp",
  ...
  {
    iconSrc: "/iimb/assets/img/Financial Decision-Making.webp",
    title: "Financial Decision-Making",
    desc: "Learn financial analysis, budgeting, and business planning with this IIM Bangalore online course.",
  },
  {
    iconSrc: "/iimb/assets/img/Strategic & Operational Thinking.webp",
  ...
  {
    iconSrc: "/iimb/assets/img/Innovation & Customer Focus.webp",
...
const toolsLearned: Tool[] = [
  {
    iconSrc: "/iimb/assets/img/AI-Powered Business Workflows.webp",
  ...
  {
    iconSrc: "/iimb/assets/img/Business Analytics & Dashboarding.webp",
  ...
  {
    iconSrc: "/iimb/assets/img/Digital Product & Customer Management.webp",
  ...
  return (
    <>
      ...
      <section id="overview" className="bg-white pt-16 pb-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-left">
            <h2 className="text-[20px] font-extrabold text-black/80 sm:text-3xl">
      ...
      <div className="text-left mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-[18px] font-extrabold text-black/80 sm:text-2xl">
      ...
      <section id="key-highlights" className="bg-white pb-16 pt-4">
        <Container>
          <div className="text-left">
            <h2 className="text-[20px] font-extrabold text-black/80 sm:text-3xl leading-tight">
              Key Skills You'll Gain with the Young Leaders Programme
            </h2>
            <p className="pt-4">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2">
            {keySkills.map((skill) => (
              <div
                key={skill.title}
                className="bg-white p-6 rounded-2xl border border-[#B12322] flex gap-2 md:gap-5 items-start text-left transition-all duration-300 hover:shadow-lg"
              >
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-black/80 leading-snug">
                    {skill.title}
                  </h3>
      ...
      >
        <Container>
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-[20px] font-extrabold text-black/80 sm:text-4xl">
          ...
          <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-3">
            {toolsLearned.map((tool) => (
              ...
              >
                <div className="flex-1 bg-white w-full h-full flex flex-col items-center text-center">
                ...
                <div className="flex flex-col gap-3 bg-[#B12322] p-4 text-white text-xs leading-relaxed text-center font-medium min-h-20 flex items-center justify-center">
