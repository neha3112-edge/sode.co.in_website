...
export default function Footer() {
  ...
  const assetsBase = "/xlri/executive-development-programme-in-human-resource-management/assets/img";
    ...
    <>
      <footer className="bg-[#f4f7fa] pt-8 sm:pt-10 lg:pt-12">
        ...
        <section id="compare-university" className="px-4 sm:px-6 lg:px-8">
          <div className="relative mx-auto max-w-446.25 rounded-[20px] bg-[#10316A] px-5 py-12 text-center text-white sm:py-14 lg:py-12 shadow-xl">
            ...
            <p className="mx-auto mt-4 max-w-4xl text-sm font-semibold leading-6 sm:text-base lg:text-lg">
              Compare XLRI Jamshedpur with Top World Renowned Universities
            </p>
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-2 gap-y-2 text-sm text-gray-900 sm:text-sm">
              <button
                ...
                className="transition-colors hover:text-[#10316A] cursor-pointer"
              >
                Disclaimer
              </button>
        ...
        {/* Bottom Bar */}
        <div className="bg-[#10316A] px-4 py-3 text-center text-sm text-white font-medium">
      ...
      {activeModal === "disclaimer" && (
        <FooterModal title="Disclaimer" onClose={closeModal}>
          ...
          <h3 className="mt-6 text-lg font-semibold text-[#10316A]">
            Essential Points
          </h3>
        ...
        <FooterModal title="Terms and Conditions" onClose={closeModal}>
          ...
          <p className="mt-2">
            ...
            <a
              ...
              className="font-medium text-[#10316A] underline"
            >
    ...
    >
      ...
      >
        ...
        <h2
          ...
          className="pr-10 text-center text-2xl font-bold text-[#10316A] sm:text-3xl"
        >
          {title}
        </h2>
