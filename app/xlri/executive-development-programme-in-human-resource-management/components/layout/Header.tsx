...
export function Header() {
  ...
  const homePath = "/xlri/executive-development-programme-in-human-resource-management";
      ...
      <Container>
        <div className="flex h-18 items-center justify-between">
          ...
          >
            {navItems.map((item, index) => (
              <div key={item.label} className="flex items-center">
                <a
                  href={item.href}
                  className="px-3 py-2 transition-colors duration-200 hover:text-[#10316A]"
                >
                  {item.label}
                </a>
          ...
          <button
            ...
            className="flex items-center justify-center rounded-md bg-[#10316A] text-white p-2 transition-all duration-300 lg:hidden"
          >
          ...
          >
            {navItems.map((item) => (
              <a
                ...
                className="rounded-md px-4 py-3 text-center transition-colors duration-200 hover:bg-gray-100 hover:text-[#10316A]"
              >
