...
export function Header() {
  ...
  const homePath = "/iim-nagpur/post-graduate-certificate-programme-in-advanced-hr-analytics";
      ...
      <Container>
        <div className="flex h-18 items-center justify-between">
          ...
          >
            {navItems.map((item, index) => (
              <div key={item.label} className="flex items-center">
                <a
                  href={item.href}
                  className="px-3 py-2 transition-colors duration-200 hover:text-[#FCB042]"
                >
                  {item.label}
                </a>
          ...
          <button
            ...
            className="flex items-center justify-center rounded-md bg-[#FCB042] text-black p-2 transition-all duration-300 lg:hidden"
          >
          ...
          >
            {navItems.map((item) => (
              <a
                ...
                className="rounded-md px-4 py-3 text-center transition-colors duration-200 hover:bg-gray-100 hover:text-[#FCB042]"
              >
