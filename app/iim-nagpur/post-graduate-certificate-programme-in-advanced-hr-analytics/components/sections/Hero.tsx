    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 z-0 hidden lg:block">
          <Image
            src={getAssetPath(`${assetsBase}/desktop_banner.webp`)}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] items-center gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left px-4 md:px-0">
              ...
              <div className="mb-5 flex items-center justify-center lg:justify-start hidden lg:block">
                <Image
                  src={getAssetPath(`${assetsBase}/IIMN.webp`)}
                  alt="IIM Nagpur logo"
                  width={200}
                  height={100}
              ...
              >
                <span className="block">Post Graduate Certificate</span>
                <span className="block">Programme in Advanced HR Analytics</span>
              </h1>

              {/* Provider */}
              <p className="mt-3 text-base sm:text-lg text-gray-800 font-medium">
                By <span className="underline font-bold">IIM Nagpur</span> via{" "}
              ...
              <p className="mt-4 max-w-md text-sm sm:text-base lg:text-[13px] leading-relaxed text-gray-700">
                The Post Graduate Certificate Programme in Advanced HR Analytics by IIM Nagpur is a 7-month online HRM post graduate programme designed for mid-career HR professionals and equips learners with the benefits of HR analytics to drive strategic workforce outcomes.
              </p>

              {/* Duration */}
              <div className="mt-4 flex items-center justify-center lg:justify-start gap-2 text-base sm:text-lg font-bold text-black">
                <Clock
                  className="text-[#231069]"
                  size={20}
                  aria-hidden="true"
                />
                <span>7 Months</span>
              ...
              <button
                ...
                className="mt-6 hidden lg:inline-flex cursor-pointer items-center justify-center gap-2 rounded-[6px] bg-[#FCB042] px-6 py-3 text-sm font-bold text-black shadow-md transition duration-200 hover:bg-[#d89127]"
              >
            ...
            <div className="w-full block lg:hidden">
              <Image
                src={getAssetPath(`${assetsBase}/IIMNMobile banner.webp`)}
                alt="IIM Nagpur Campus"
                width={500}
                height={290}
                priority
            ...
            <div className="flex justify-center lg:justify-end w-full px-4 md:px-0 -mt-10 md:mt-0">
              <div className="w-full max-w-md rounded-2xl border border-gray-100 bg-white px-5 py-6 sm:px-6 shadow-2xl">
                ...
                <div className="mb-4 text-center">
                  <h2 className="text-[22px] sm:text-[25px] font-extrabold text-[#FCB042]">
                    Admission Open
                  </h2>
                  ...
                  <div className="mt-2.5 flex justify-center">
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-[#FCB042] px-5 py-1.5 text-xs font-bold text-black transition-colors hover:bg-[#d89127]"
                    >
                      <PhoneCall
                        size={12}
                        fill="currentColor"
                ...
                <FormWrapper
                  ...
                  defaultCourse=""
                  formNameOverride="IIMN Hero Enquiry Form"
      ...
      {/* =====================================================
          STATS BAR
      ====================================================== */}
      <section className="bg-[#FCB042] py-8 text-black" id="stats">
        <Container>
          <div className="grid grid-cols-2 gap-x-4 gap-y-6 md:grid-cols-4 md:gap-x-8 md:gap-y-0">
            ...
            <StatItem
              ...
              value="Eligibility"
              label="Bachelor's Degree + 2 yrs Exp"
            />
          </div>
        </Container>
      </section>
      ...
      {downloadOpen && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-label="Download IIM Nagpur brochure"
            onClick={(event) => event.stopPropagation()}
            className="relative max-h-[92vh] w-full max-w-sm overflow-y-auto rounded-xl bg-white p-6 shadow-2xl"
          >
            <FormWrapper
              title="Download Brochure"
              subtitle="Select your course to receive the IIM Nagpur brochure"
              onClose={closeDownloadForm}
              courseOptions={IIMN_COURSE_OPTIONS}
              defaultCourse=""
              formNameOverride="IIMN Download Brochure Form"
              sourceOverride="IIMN LP"
              utmSourceFallback="Organic"
              utmMediumFallback="IIMN_Organic"
