  ...
  */
  ...
  return (
    <>
      <section
        id="home"
        className="relative min-h-107.5 scroll-mt-18 overflow-hidden bg-[#e9f0ff] px-0"
      >
        {/* =============================================================
        ...
        <Image
          src={getAssetPath("iitkgp/assets/img/Desktop banner.webp")}
        ...
        <div className="absolute inset-y-0 left-0 hidden w-[59%] bg-linear-to-r from-[#eef2ff] via-[#eef2ff]/95 to-transparent lg:block" />
        ...
        <Container className="relative z-10 p-0">
          <div className="grid min-h-107.5 grid-cols-1 items-center gap-8 py-8 lg:grid-cols-[minmax(0,1fr)_376px] lg:gap-12 lg:py-10">
            {/* =========================================================
                Left Content
            ========================================================== */}

            <div className="mx-auto w-full max-w-162.5 text-center lg:mx-0 lg:text-left px-4 md:px-0">
              {/* IIT Kharagpur + upGrad Logo */}
              <div className="mb-4 flex justify-center lg:justify-start">
                <Image
                  src={getAssetPath("/iitkgp/assets/img/IIT Kharagpur.webp")}
                  alt="IIT Kharagpur and upGrad"
                  width={430}
                  height={65}
                  priority
                  className="h-auto w-full max-w-82.5 object-contain object-left"
                />
              </div>

              {/* Certificate label */}
              <div className="flex justify-center lg:justify-start">
                <div className="inline-flex rounded-[9px] border border-[#174da5] bg-white/35 px-3 py-1.25">
              ...
              {/* Main heading */}
              <h1 className="mt-2 text-[37px] font-black leading-[0.98] tracking-[-0.045em] text-[#174da5] sm:text-[47px] lg:text-[42px] py-2">
              ...
              <p className="mt-3 text-[15px] font-medium leading-tight text-[#111111] sm:text-[17px]">
                From{" "}
                <span className="font-extrabold underline decoration-[1.5px] underline-offset-2">
                  IIT Kharagpur
                </span>{" "}
                via{" "}
                <span className="font-extrabold underline decoration-[1.5px] underline-offset-2">
              ...
              {/* Description */}
              <p className="mx-auto mt-3 max-w-130 text-[14px] font-medium leading-[1.2] text-[#161616] sm:text-[15.5px] lg:mx-0">
              ...
              <button
                ...
                className="mt-7 inline-flex min-h-10.25 items-center justify-center gap-2 rounded-lg bg-[#174da5] px-5 py-3 text-[13px] font-extrabold text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#103d87] hover:shadow-md"
              >
                Download Brochure
            ...
            <div className="mobile_img md:hidden">
              <Image
                  src="iitkgp/assets/img/Mobile banner .webp"
                  alt="IIT Kharagpur and upGrad"
                  width={430}
                  height={65}
                  priority
            ...
            <div className="hidden justify-end lg:flex">
              <div className="w-full max-w-94 rounded-[11px] bg-white px-5 pb-4.5 pt-4.5 shadow-[0_8px_24px_rgba(0,0,0,0.24)]">
                <FormWrapper
                  title="Enquire Now"
          ...
          <div className="pb-10 lg:hidden px-4 md:px-0 -mt-10">
      ...
      {downloadOpen && (
        ...
        >
          <div
            ...
            className="relative max-h-[92vh] w-full max-w-105 overflow-y-auto rounded-xl bg-white p-6 shadow-2xl"
          >
            {/* Close Button */}
            <button
              type="button"
