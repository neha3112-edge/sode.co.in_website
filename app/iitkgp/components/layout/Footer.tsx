...
export default function Footer() {
  ...
  */
  ...
  return (
    <>
      <footer className="overflow-hidden bg-[#f4f7fa] pt-12 sm:pt-14 lg:pt-15">
        {/* =============================================================
            Compare University Section
        ============================================================== */}

        <section className="px-4 sm:px-8 lg:px-15">
          <div className="relative mx-auto max-w-[1800px] rounded-[20px] bg-[#ff5200] px-5 pb-21.5 pt-12 text-center text-white sm:pb-22.5 sm:pt-14 lg:pb-22">
            <h2 className="text-[21px] font-extrabold leading-tight sm:text-[24px]">
              Still Confused?
            </h2>

            <p className="mx-auto mt-5 max-w-212.5 text-[14px] font-extrabold leading-6 sm:text-[16px]">
              Compare IIT Kharagpur University with Top World Renowned Universities
            </p>
            ...
            <button
              ...
              className="absolute -bottom-10.75 left-1/2 flex h-21.5 w-21.5 -translate-x-1/2 cursor-pointer items-center justify-center rounded-full bg-white shadow-[0_5px_15px_rgba(0,0,0,0.12)] transition-transform duration-300 hover:scale-105"
            >
              <Image
                src="iitkgp/assets/img/arrow.gif"
        ...
        <section className="px-4 pb-7 pt-19.5 sm:px-8 sm:pt-21.25">
          <button
            type="button"
            onClick={openComparePage}
          ...
          >
            <Image
              ...
              width={950}
              height={260}
              className="mx-auto h-auto w-full max-w-237.5 object-contain"
            />
          </button>
        </section>
        ...
        <section className="px-4 pb-5 sm:px-8">
          <div className="mx-auto max-w-[1800px] text-center">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-1.5 gap-y-2 text-[13px] font-extrabold text-black sm:text-[14px]">
              <button
                type="button"
        ...
        <div className="bg-[#333333] px-4 py-3 text-center text-[12px] font-medium text-white sm:text-[13px]">
