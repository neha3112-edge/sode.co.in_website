    ...
    <>
      <section id="about" className="relative w-full bg-[#005ca8] text-white overflow-hidden">
        ...
        <Container className="relative z-10 px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] py-12 lg:py-20 items-center">
            {/* Left Text Column */}
            <div className="max-w-[620px]">
              <h2 className="text-[28px] sm:text-[34px] font-bold text-white tracking-wide uppercase mb-6">
                ABOUT US
              </h2>
              <div className="space-y-6 text-[15px] sm:text-[16px] leading-relaxed text-white/90">
                <p>
            ...
            <div className="mt-8 w-full max-w-lg mx-auto rounded-xl overflow-hidden shadow-lg lg:hidden">
              <img
                src="/rushford/assets/img/rushford-campus-buiding.webp"
                alt="Rushford Switzerland Campus"
