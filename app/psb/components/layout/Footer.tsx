    ...
    <>
      <footer className="overflow-hidden bg-[#f4f7fa] pt-12 sm:pt-14 lg:pt-[60px]">
        ...
        <section className="px-4 sm:px-8 lg:px-[60px]">
          <div className="relative mx-auto max-w-[1800px] rounded-[20px] bg-[#233568] px-5 pb-[60px] pt-12 text-center text-white sm:pb-[70px] sm:pt-14 lg:pb-[60px]">
            <h2 className="text-[21px] font-extrabold leading-tight sm:text-[24px]">
              Still Confused?
            </h2>

            <p className="mx-auto mt-5 max-w-[850px] text-[14px] font-semibold leading-6 sm:text-[16px]">
              Compare Paris School of Business University with Top World Renowned Universities
            </p>
          ...
          <div className="mx-auto max-w-[1800px] text-center">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-1.5 gap-y-2 text-[13px] font-semibold text-black sm:text-[14px]">
              <button
                ...
                className="cursor-pointer transition-colors hover:text-[#233568]"
              >
                Disclaimer
              </button>
