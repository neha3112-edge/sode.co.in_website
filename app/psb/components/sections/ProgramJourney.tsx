...
const journeySteps: JourneyStep[] = [
  {
    id: 1,
    step: "Step 01",
    title: "Executive Programme in Strategy, Finance, AI and Leadership",
    duration: "(4 Months)",
    description:
      "This phase covers modern management principles through four new-age management modules and features 100% live teaching by renowned IIM Lucknow faculty, structured around the working week for maximum flexibility. Participants earn an Executive Programme Certificate from IIM Lucknow upon completion.",
    logo: "/psb/assets/img/IIML.webp",
  ...
  },
  {
    ...
    duration: "(14 Months)",
    description:
      "The second phase is delivered by Paris School of Business and leads to a Master of Business Administration degree along with PSB Alumni Status. Participants follow the same curriculum as the full-time MBA programme, choose from five modern specialisations, and learn through live and recorded sessions delivered by world-class faculty and industry experts.",
    logo: "/psb/assets/img/psb-logo.png",
    logoAlt: "Paris School of Business logo",
  ...
  },
  {
    ...
    duration: "",
    description:
      "Personalise your MBA by selecting two specialisations from five contemporary domains: Strategic Leadership, AI and Technology, Finance, Marketing, and Operations & Supply Chain. These specialised tracks help learners deepen their expertise in areas aligned with their professional goals.",
    logo: "/psb/assets/img/psb-logo.png",
    logoAlt: "Paris School of Business logo",
  ...
  },
  {
    id: 4,
    step: "Step 04",
    title: "CEO Challenge Project",
    duration: "",
    description:
      "The programme culminates in the CEO Challenge Project, where participants apply the concepts, frameworks, and tools learned throughout the MBA to solve a live business challenge for a partner organisation. Working with organisational data and business leaders, participants develop strategic recommendations designed to create measurable business impact.",
    logo: "/psb/assets/img/psb-logo.png",
    logoAlt: "Paris School of Business logo",
      ...
      >
        <Container className="max-w-[1300px]">
          ...
          <div className="text-center">
            <h2 className="text-3xl font-extrabold tracking-tight text-[#233568] sm:text-4xl">
              MBA Program Journey
            </h2>
            <p className="mt-2 text-sm text-gray-500 font-medium sm:text-base">
              PSB +IIM L MBA Pathway
            </p>
          </div>
          ...
          <div className="mt-12 flex justify-center">
            <button
              ...
              className="inline-flex min-h-[46px] items-center justify-center gap-2 rounded-full bg-[#233568] hover:bg-[#1a2850] px-8 py-3 text-sm font-bold text-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
            >
              Get 1:1 Counseling
              <ArrowRight size={16} />
            </button>
        ...
        >
          ...
          >
            <FormWrapper
              ...
              defaultCourse=""
              formNameOverride="PSB Journey Counseling Form"
              sourceOverride="PSB LP"
              utmSourceFallback="PSB Organic"
              utmMediumFallback="PSB Journey Counseling Button"
